...
namespace Dillon.Server.Input
{
    ...
    public class KeyboardSimulatorAdapter
        ...
        {
            _inputSimulator.ModifiedKeyStroke((WindowsInput.Native.VirtualKeyCode)modifierKey, keyCodes.Cast<WindowsInput.Native.VirtualKeyCode>());
            return this;
        }

        public IKeyboardSimulator ModifiedKeyStroke(VirtualKeyCode modifierKeyCode, VirtualKeyCode keyCode)
        {
            _inputSimulator.ModifiedKeyStroke((WindowsInput.Native.VirtualKeyCode)modifierKeyCode, (WindowsInput.Native.VirtualKeyCode)keyCode);
            return this;
        }

        public IKeyboardSimulator ModifiedKeyStroke(IEnumerable<VirtualKeyCode> modifierKeyCodes, VirtualKeyCode keyCode)
        {
            _inputSimulator.ModifiedKeyStroke(modifierKeyCodes.Cast<WindowsInput.Native.VirtualKeyCode>(), (WindowsInput.Native.VirtualKeyCode)keyCode);
            return this;
        }
        ...
        {
            _inputSimulator.ModifiedKeyStroke(modifierKeyCodes.Cast<WindowsInput.Native.VirtualKeyCode>(), keyCodes.Cast<WindowsInput.Native.VirtualKeyCode>());
            return this;
        }
        ...
        private WindowsInput.IKeyboardSimulator _inputSimulator;
    }
}
